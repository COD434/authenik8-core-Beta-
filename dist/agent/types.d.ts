...
export interface AgentIdentityConfig {
    ...
    resolveAgent: (agentId: string) => RegisteredAgentIdentity | null | Promise<RegisteredAgentIdentity | null>;
    /** Delegation fails closed when this policy is omitted or returns false. */
    authorizeDelegation?: (request: AgentDelegationRequest) => boolean | Promise<boolean>;
}
